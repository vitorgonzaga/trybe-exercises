...
// const seuImc = imc.imc(peso, altura);
...
// console.log(
//   `Olá, ${name}! Você tem ${peso} de peso e ${altura} de altura. Seu imc é: ${seuImc}. Classificacao: ${classImc}`
//   );

// const classImc = imc.classificaImc(seuImc);
