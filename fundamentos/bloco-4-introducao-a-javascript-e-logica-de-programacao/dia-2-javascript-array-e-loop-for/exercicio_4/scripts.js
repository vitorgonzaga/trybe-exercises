...
// Utilizando o array acima imprima o resultado da divisão de cada um dos elementos por 2

for (let index = 0 ; index < numbersTo25.length ; index += 1) {
  let division = numbersTo25[index] / 2
